...
<body title="降水单时次不分级检验" style="padding: 0; margin: 0;">
        ...
        <td style="width: 100%">
            ...
            <div id="tb" style="padding: 3px">
                ...
                <input class="easyui-datebox" id="endTime" name="endTime"
                       value="" type="text" style="width: 100px;">
                <span style="margin-left: 20px;">时次：</span>
                ...
                <a href="#" class="easyui-linkbutton" style="margin-left: 20px;" onclick="doSearch()" icon="icon-search">查询</a>
            </div>
        </td>
    </tr>
    </tbody>
...
<script type="text/javascript">
    function doSearch(){
        var queryParams ={
            ...
            forecastType: $('#forecastType').combobox('getText'),
            forecaster: $('#forecaster').combobox('getValue')
        };
        $('#tt').datagrid({
            url: "${contextPath}/check/rainfall/normalMul/dataList",
            queryParams: queryParams
        });
        window.parent.rainfall.normalMulChart(queryParams);
    }
