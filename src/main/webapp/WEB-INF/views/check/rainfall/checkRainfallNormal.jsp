...
<script type="text/javascript">
    function doSearch(){
        ...
        $('#tt').datagrid({
            url: "${contextPath}/check/rainfall/normal/dataList",
            queryParams: queryParams
        });
        window.parent.rainfall.normalChart(queryParams);
    }
    $(document).ready(function(){
        ...
        $('#tt').datagrid({
            ...
            columns:[[
                ...
                {field:'rightCount', title:'准确格点数   ', width:80,
                    formatter: function(value,row,index){
                        if (value!=null){
                            return value;
                        } else {
                ...
                {field:'allCount', title:'格点总数', width:80,
                    formatter: function(value,row,index){
                        if (value!=null){
                            return value;
                        } else {
