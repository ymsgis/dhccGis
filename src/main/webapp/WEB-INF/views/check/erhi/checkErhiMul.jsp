...
<body title="最小相对湿度多时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkErhi/normalMul/loadList",
		queryParams: queryParams
	});
	window.parent.erhi.normalMulChart(queryParams);
}
