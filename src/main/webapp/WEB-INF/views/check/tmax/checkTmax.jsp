...
<body title="最高温度单时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkTmax/normal/loadList",
		queryParams: queryParams
	});
	window.parent.tmax.normalChart(queryParams);
}
