...
<body title="最高温度多时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkTmax/normalMul/loadList",
		queryParams: queryParams
	});
	window.parent.tmax.normalMulChart(queryParams);
}
$(document).ready(function(){
    ...
    $('#tt').datagrid({
        ...
        columns:[[
            ...
            {field:'twoDegreesAccuracy', title:'≤2℃准确率', width:80,
                formatter: function(value,row,index){
                    if (value!=null){
                        return value;
                    } else {
