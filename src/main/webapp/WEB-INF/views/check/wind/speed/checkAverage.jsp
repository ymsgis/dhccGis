...
<body title="风速检验平均结果" style="padding: 0; margin: 0;">
        ...
        <td style="width: 100%">
            ...
            <div id="tb" style="padding: 3px">
                ...
                <select id="checkLevel" class="easyui-combobox" name="timeType" style="width: 120px;">
                    ...
                    <option value="high">8级级以上</option>
                </select>
                <span>预报员</span>
...
<script type="text/javascript">
    function doSearch(){
        $('#tt').datagrid({
            url: "${contextPath}/check/windSpeed/average/dataList",
            queryParams: {
