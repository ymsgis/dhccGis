...
<body title="风速单时次检验" style="padding: 0; margin: 0;">
    ...
    <tr>
        <td style="width: 100%">
            ...
            <div id="tb" style="padding: 3px">
                ...
                <span>风速等级:</span>
                <select id="checkLevel" class="easyui-combobox" name="timeType" style="width: 120px;">
                    <option value="all">所有等级</option>
                    <option value="low">6级及以下</option>
                    <option value="middle">6-8级</option>
                    <option value="high">8级及以上</option>
                </select>
                <span>预报员</span>
...
<script type="text/javascript">
    function doSearch(){
        var queryParams = {
            ...
            checkLevel: $('#checkLevel').combobox('getValue'),
            forecaster: $('#forecaster').combobox('getText')
        };
        $('#tt').datagrid({
            url: "${contextPath}/check/windSpeed/normal/dataList",
            queryParams: queryParams
        });
        window.parent.windSpeed.normalChart(queryParams);
    }
    $(document).ready(function(){
        ...
        $('#tt').datagrid({
            ...
            columns:[[
                ...
                {
                    field:'checkLevel', title:'风速等级', width:100,
                    formatter: function(value,row,index){
                        if (value!=null) {
                            if ("all" == value) {
                                return "所有等级";
                ...
                {field:'wmab', title:'绝对误差', width:100,
                    formatter: function(value,row,index){
                        if (value!=null){
                            if(9999 != value){
                                value = value.toFixed(2);
                ...
                {field:'acz', title:'综合准确率', width:100,
                    formatter: function(value,row,index){
                        if (value!=null){
                            if(9999 != value){
                                value = value.toFixed(2);
