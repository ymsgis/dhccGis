...
<body title="温度检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkAssessmentTmp/normal/loadList",
		queryParams: queryParams
	});
	window.parent.tmp.normalChart(queryParams);
}
