...
<body title="最大相对湿度多时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkErha/normalMul/loadList",
		queryParams: queryParams
	});
	window.parent.erha.normalMulChart(queryParams);
}
