...
<body title="最大相对湿度单时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkErha/normal/loadList",
		queryParams: queryParams
	});
	window.parent.erha.normalChart(queryParams);
}
