...
<body title="湿度单时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkErh/normal/loadList",
		queryParams: queryParams
	});
	window.parent.erh.normalChart(queryParams);
}
