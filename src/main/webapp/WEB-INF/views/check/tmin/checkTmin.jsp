...
<body title="最低温度单时效检验" style="padding: 0; margin: 0;">
			...
			<tr>
				<td style="width: 100%">
					...
					<div id="tb" style="padding: 3px">
						...
						<span>时效：</span> 
						<select id="aging" name="aging" value="3" class="easyui-combobox" style="width: 50px;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkTmin/normal/loadList",
		queryParams: queryParams
	});
	window.parent.tmin.normalChart(queryParams);
}
$(document).ready(function(){
    ...
    $('#tt').datagrid({
        ...
        columns:[[
            ...
            {field:'twoDegreesAccuracy', title:'≤2℃准确率', width:90,
                formatter: function(value,row,index){
                    if (value!=null){
                        return value;
                    } else {
