...
<body title="最低温度多时效检验" style="padding: 0; margin: 0;">
...
function doSearch(){
	...
	$('#tt').datagrid({
		url: "${contextPath}/check/checkTmin/normalMul/loadList",
		queryParams: queryParams
	});
	window.parent.tmin.normalMulChart(queryParams);
}
