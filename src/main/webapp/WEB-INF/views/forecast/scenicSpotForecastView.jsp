...
<script type="text/javascript" src="./scenicSpotForecastView.jsx"></script>
<style type="text/css">
body,html {
	padding: 0;
	margin: 0;
...
<div  class="easyui-panel" title="">
	...
	<div class="easyui-panel qhCon">
		<form id="searchForm" method="post" style="padding: 2px;">
			<ul class="formSech">
			<li>
			<label>预报日期：<input type="text" class="easyui-datebox" name="createTime" style="width:100px;" test-value="2017-12-13" /></label></li>
			<li><label>预报时次：<select class="easyui-combobox" name="timeType" style="width: 50px;" editable="false">
				<option>10</option>
				<option>16</option>
			</select></label></li>
			<li><a class="easyui-linkbutton submit btnBxb" icon="icon-search">查询</a>
			<a class="easyui-linkbutton submit btnBxb" rel="gridmake" icon="icon-save">格点生成</a></li>
			</ul>
		</form>
	</div>
