...
tmp.normalChart=function (data) {
    ...
    $.ajax({
        url: _tmpPath + '/check/checkAssessmentTmp/normal/loadList',
        type: "post",
        dataType: 'json',
        data: data,
...
tmp.normalMulChart=function (data) {
var myChart = echarts.init(document.getElementById('tmpEchart'));
    ...
    $.ajax({
        url: _tmpPath + '/check/checkAssessmentTmp/normalMul/loadList',
        type: "post",
        dataType: 'json',
        data: data,
        success: function(data){
