 ...
 */
var tmin = window.tmp || {};
tmin.normalChart=function (data) {
    ...
    $.ajax({
        url: _tmpPath + '/check/checkTmin/normal/loadList',
        type: "post",
        dataType: 'json',
        data: data,
...
tmin.normalMulChart=function (data) {
var myChart = echarts.init(document.getElementById('tmpEchart'));
    ...
    $.ajax({
        url: _tmpPath + '/check/checkTmin/normalMul/loadList',
        type: "post",
        dataType: 'json',
        data: data,
        success: function(data){
