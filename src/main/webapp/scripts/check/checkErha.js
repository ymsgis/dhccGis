 ...
 */
var erha = window.erh || {};
erha.normalChart=function (data) {
    ...
    $.ajax({
        url: _tmpPath + '/check/checkErha/normal/loadList',
        type: "post",
        dataType: 'json',
        data: data,
...
erha.normalMulChart=function (data) {
var myChart = echarts.init(document.getElementById('tmpEchart'));
    ...
    $.ajax({
        url: _tmpPath + '/check/checkErha/normalMul/loadList',
        type: "post",
        dataType: 'json',
        data: data,
        success: function(data){
